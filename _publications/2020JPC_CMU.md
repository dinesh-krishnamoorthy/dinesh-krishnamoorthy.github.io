...
[Download paper here](http://folk.ntnu.no/dineshk/Papers/2020/JPCCMU.pdf)
...
- Nominal stability of the adaptive horizon economic NMPC is shown.
- Two examples demonstrate that the proposed adaptive horizon economic NMPC provides similar performance as the standard economic NMPC with significantly less computation time.
